...
const description =
  "Try Gramclaw’s public demo: a local-first Instagram visual memory with private media analysis, natural-language image search, smart Saved collections, moodboards, archives, DMs, and agent-ready JSON.";
